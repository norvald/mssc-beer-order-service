...
public class FailedAllocationAction implements Action<BeerOrderStatusEnum, BeerOrderEventEnum> {
    ...
    public void execute(StateContext<BeerOrderStatusEnum, BeerOrderEventEnum> context) {
        ...
        log.error("Compensation Transaction - Allocation failed: " + beerOrderId);

        jmsTemplate.convertAndSend(JmsConfig.FAILED_ALLOCATION_QUEUE, FailedAllocationRequest.builder()
